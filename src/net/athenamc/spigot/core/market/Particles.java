...
public class Particles extends Market {
	private Inventory inv;

	public Particles(SpigotCore plugin) {
		super(plugin);
		inv = Bukkit.createInventory(null, 54, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Particles");
